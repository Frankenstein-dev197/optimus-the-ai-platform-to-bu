...
import { OptimusAgentsPageView } from "./OptimusAgentsPageView";
...
const OptimusAgentsPage: FC = () => {
	...
	return (
		<RequirePermission isFeatureVisible={canEditDeploymentConfig}>
			<title>{pageTitle("Optimus Agents", "AI Settings")}</title>
...
export default OptimusAgentsPage;
