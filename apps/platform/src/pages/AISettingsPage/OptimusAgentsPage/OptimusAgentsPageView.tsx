...
export interface OptimusAgentsPageViewProps {
...
export const OptimusAgentsPageView: FC<OptimusAgentsPageViewProps> = ({
	adminOverridesData,
	adminOverridesError,
	...
	return (
		<div className="flex max-w-4xl flex-col gap-8">
			<SettingsHeader>
				<SettingsHeaderTitle>Optimus Agents</SettingsHeaderTitle>
				<SettingsHeaderDescription>
					Configure deployment-wide defaults for Optimus Agents and
			...
			<div className="flex flex-col gap-6 rounded-lg border border-solid border-border px-6 py-7">
				...
				<SubagentModelOverrideSettings
					...
					description="Leave unset to use Optimus's title default, which prefers fast models from configured providers."
