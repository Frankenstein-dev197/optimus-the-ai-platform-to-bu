...
import {
	...
	type OptimusIDECollabAgentsPageViewProps,
} from "./OptimusIDECollabAgentsPageView";
...
const buildArgs = (
	overrides: Partial<OptimusIDECollabAgentsPageViewProps> = {},
): OptimusIDECollabAgentsPageViewProps => ({
...
const meta = {
	title: "pages/AISettingsPage/OptimusIDECollabAgentsPage/OptimusIDECollabAgentsPageView",
	component: OptimusIDECollabAgentsPageView,
	// TODO: Stories in this file fail when pixel runs their play functions. Fix them and remove the exclude.
	parameters: { pixel: { exclude: true } },
	args: buildArgs(),
} satisfies Meta<typeof OptimusIDECollabAgentsPageView>;

export default meta;
type Story = StoryObj<typeof OptimusIDECollabAgentsPageView>;
