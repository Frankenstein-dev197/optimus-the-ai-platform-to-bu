		...
		<div className="flex flex-col gap-12">
			<div>
				<SettingsHeader>
					...
					<SettingsHeaderDescription>
						Customize the look and feel of your Optimus deployment.
					</SettingsHeaderDescription>
				</SettingsHeader>
						...
						<FormFields>
							...
							<IconField
								{...getFieldHelpers("logo_url", {
									helperText: isEntitled
										? "Leave empty to use the Optimus logo. An image with transparency and an aspect ratio of 3:1 or less will look best."
										: "This is an Enterprise only feature.",
								})}
								label="Logo URL"
								placeholder="/icon/optimus.svg"
								disabled={fieldsDisabled}
								onPickEmoji={(value) => {
