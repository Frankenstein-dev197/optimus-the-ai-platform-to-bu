...
export function CodeView<T = unknown>(props: CodeViewProps<T>): React.JSX.Element {
  ...
  const { ref: _ref, items, selectedLineRange, selectedLines, annotations, showAnnotations, className, style, onLineClick, onScroll, renderCustomHeader, renderAnnotation, options, ...rest } = props;
