...
describe("TerminalPage", () => {
	...
	it("resizes on connect", async () => {
		...
		const req = JSON.parse(new TextDeoptimus-ide-collab().decode(msg as Uint8Array));
	...
	it("supports shift+enter", async () => {
		...
		const req = JSON.parse(new TextDeoptimus-ide-collab().decode((await msg) as Uint8Array));
	...
	it("executes command after confirmation", async () => {
		...
		const resizeReq = JSON.parse(new TextDeoptimus-ide-collab().decode(msg as Uint8Array));
